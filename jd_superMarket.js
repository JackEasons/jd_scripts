...
支持京东双账号
京小超兑换奖品请使用此脚本 https://raw.githubusercontent.com/JackEasons/jd_scripts/master/jd_blueCoin.js
脚本兼容: QuantumultX, Surge, Loon, JSBox, Node.js
// QuantumultX
[task_local]
#东东超市
11 1-23/5 * * * https://raw.githubusercontent.com/JackEasons/jd_scripts/master/jd_superMarket.js, tag=东东超市, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jxc.png, enabled=true
// Loon
[Script]
cron "11 1-23/5 * * *" script-path=https://raw.githubusercontent.com/JackEasons/jd_scripts/master/jd_superMarket.js,tag=东东超市
// Surge
东东超市 = type=cron,cronexp="11 1-23/5 * * *",wake-system=1,timeout=320,script-path=https://raw.githubusercontent.com/JackEasons/jd_scripts/master/jd_superMarket.js
 */
const $ = new Env('东东超市');
...
async function businessCircleActivity() {
  ...
  if (businessCirclePKDetailRes && businessCirclePKDetailRes.data.bizCode === 0) {
    ...
    console.log(`您暂未加入商圈,现在给您加入JackEasons的商圈`);
    ...
    if (joinBusinessCircleRes.data.bizCode !== 0) {
      console.log(`您加入JackEasons的商圈失败，现在给您随机加入一个商圈`);
...
//=============================================脚本使用到的京东API=====================================
function updatePkActivityId(url = 'https://raw.githubusercontent.com/JackEasons/updateTeam/master/jd_updateTeam.json') {
  return new Promise(resolve => {
    //https://cdn.jsdelivr.net/gh/JackEasons/updateTeam@master/jd_updateTeam.json
    //https://raw.githubusercontent.com/JackEasons/updateTeam/master/jd_updateTeam.json
...
function updatePkActivityIdCDN(url = 'https://cdn.jsdelivr.net/gh/JackEasons/updateTeam@master/jd_updateTeam.json') {
  return new Promise(resolve => {
    //https://cdn.jsdelivr.net/gh/JackEasons/updateTeam@master/jd_updateTeam.json
    //https://raw.githubusercontent.com/JackEasons/updateTeam/master/jd_updateTeam.json
    $.get({url}, async (err, resp, data) => {
